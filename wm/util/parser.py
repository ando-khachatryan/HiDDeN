...
def create_new_run_subparser(newrun_parser: ArgumentParser, network_type: str):
    ...
    newrun_parser.add_argument('--job-name', required=False, type=str, help='String representation for the experiment name')
...
#     if network_type.startswith('unet'):
#         newrun_parser.add_argument('--use_dropout', dest='use_dropout', action='store_true', help='enable dropout in unet encoder')
#         newrun_parser.set_defaults(use_dropout=False)
    
#     newrun_parser.set_defaults(remaining_defaults)
