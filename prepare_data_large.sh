...
mkdir -p large/test/test_class

find ./train2017 -maxdepth 1 -type f -print0 | head -z -n 103000 | xargs -0 -r -- cp -t "large/train/train_class" --
find ./large/train/train_class -maxdepth 1 -type f -print0 | head -z -n -3000 | xargs -0 -r -- mv -t "large/test/test_class"
echo "Done"
echo "./large/train/ $(ls -l ./large/train/train_class | egrep -c '^-') files"
echo "./large/test/  $(ls -l ./large/test/test_class   | egrep -c '^-') files"
